 ...
 * http://jquery.org/license
 */
n.widget("ui.tooltip",{version:"1.12.1",options:{classes:{"ui-tooltip":"ui-corner-all ui-widget-shadow"},content:function(){var t=n(this).attr("title")||"";return n("<a>").text(t).html()},hide:!0,items:"[title]:not([disabled])",position:{my:"left top+15",at:"left bottom",collision:"flipfit flip"},show:!0,track:!1,close:null,open:null},_addDescribedBy:function(t,i){var r=(t.attr("aria-describedby")||"").split(/\s+/);r.push(i);t.data("ui-tooltip-id",i).attr("aria-describedby",n.trim(r.join(" ")))},_removeDescribedBy:function(t){var u=t.data("ui-tooltip-id"),i=(t.attr("aria-describedby")||"").split(/\s+/),r=n.inArray(u,i);r!==-1&&i.splice(r,1);t.removeData("ui-tooltip-id");i=n.trim(i.join(" "));i?t.attr("aria-describedby",i):t.removeAttr("aria-describedby")},_create:function(){this._on({mouseover:"open",focusin:"open"});this.tooltips={};this.parents={};this.liveRegion=n("<div>").attr({role:"log","aria-live":"assertive","aria-relevant":"additions"}).appendTo(this.document[0].body);this._addClass(this.liveRegion,null,"ui-helper-hidden-accessible");this.disabledTitles=n([])},_setOption:function(t,i){var r=this;this._super(t,i);t==="content"&&n.each(this.tooltips,function(n,t){r._updateContent(t.element)})},_setOptionDisabled:function(n){this[n?"_disable":"_enable"]()},_disable:function(){var t=this;n.each(this.tooltips,function(i,r){var u=n.Event("blur");u.target=u.currentTarget=r.element[0];t.close(u,!0)});this.disabledTitles=this.disabledTitles.add(this.element.find(this.options.items).addBack().filter(function(){var t=n(this);if(t.is("[title]"))return t.data("ui-tooltip-title",t.attr("title")).removeAttr("title")}))},_enable:function(){this.disabledTitles.each(function(){var t=n(this);t.data("ui-tooltip-title")&&t.attr("title",t.data("ui-tooltip-title"))});this.disabledTitles=n([])},open:function(t){var r=this,i=n(t?t.target:this.element).closest(this.options.items);i.length&&!i.data("ui-tooltip-id")&&(i.attr("title")&&i.data("ui-tooltip-title",i.attr("title")),i.data("ui-tooltip-open",!0),t&&t.type==="mouseover"&&i.parents().each(function(){var t=n(this),i;t.data("ui-tooltip-open")&&(i=n.Event("blur"),i.target=i.currentTarget=this,r.close(i,!0));t.attr("title")&&(t.uniqueId(),r.parents[this.id]={element:this,title:t.attr("title")},t.attr("title",""))}),this._registerCloseHandlers(t,i),this._updateContent(i,t))},_updateContent:function(n,t){var r,i=this.options.content,u=this,f=t?t.type:null;if(typeof i=="string"||i.nodeType||i.jquery)return this._open(t,n,i);r=i.call(n[0],function(i){u._delay(function(){n.data("ui-tooltip-open")&&(t&&(t.type=f),this._open(t,n,i))})});r&&this._open(t,n,r)},_open:function(t,i,r){function s(n){(o.of=n,u.is(":hidden"))||u.position(o)}var f,u,h,e,o=n.extend({},this.options.position);if(r){if(f=this._find(i),f){f.tooltip.find(".ui-tooltip-content").html(r);return}i.is("[title]")&&(t&&t.type==="mouseover"?i.attr("title",""):i.removeAttr("title"));f=this._tooltip(i);u=f.tooltip;this._addDescribedBy(i,u.attr("id"));u.find(".ui-tooltip-content").html(r);this.liveRegion.children().hide();e=n("<div>").html(u.find(".ui-tooltip-content").html());e.removeAttr("name").find("[name]").removeAttr("name");e.removeAttr("id").find("[id]").removeAttr("id");e.appendTo(this.liveRegion);this.options.track&&t&&/^mouse/.test(t.type)?(this._on(this.document,{mousemove:s}),s(t)):u.position(n.extend({of:i},this.options.position));u.hide();this._show(u,this.options.show);this.options.track&&this.options.show&&this.options.show.delay&&(h=this.delayedShow=setInterval(function(){u.is(":visible")&&(s(o.of),clearInterval(h))},n.fx.interval));this._trigger("open",t,{tooltip:u})}},_registerCloseHandlers:function(t,i){var r={keyup:function(t){if(t.keyCode===n.ui.keyCode.ESCAPE){var r=n.Event(t);r.currentTarget=i[0];this.close(r,!0)}}};i[0]!==this.element[0]&&(r.remove=function(){this._removeTooltip(this._find(i).tooltip)});t&&t.type!=="mouseover"||(r.mouseleave="close");t&&t.type!=="focusin"||(r.focusout="close");this._on(!0,i,r)},close:function(t){var u,f=this,i=n(t?t.currentTarget:this.element),r=this._find(i);if(!r){i.removeData("ui-tooltip-open");return}(u=r.tooltip,r.closing)||(clearInterval(this.delayedShow),i.data("ui-tooltip-title")&&!i.attr("title")&&i.attr("title",i.data("ui-tooltip-title")),this._removeDescribedBy(i),r.hiding=!0,u.stop(!0),this._hide(u,this.options.hide,function(){f._removeTooltip(n(this))}),i.removeData("ui-tooltip-open"),this._off(i,"mouseleave focusout keyup"),i[0]!==this.element[0]&&this._off(i,"remove"),this._off(this.document,"mousemove"),t&&t.type==="mouseleave"&&n.each(this.parents,function(t,i){n(i.element).attr("title",i.title);delete f.parents[t]}),r.closing=!0,this._trigger("close",t,{tooltip:u}),r.hiding||(r.closing=!1))},_tooltip:function(t){var i=n("<div>").attr("role","tooltip"),r=n("<div>").appendTo(i),u=i.uniqueId().attr("id");return this._addClass(r,"ui-tooltip-content"),this._addClass(i,"ui-tooltip","ui-widget ui-widget-content"),i.appendTo(this._appendTo(t)),this.tooltips[u]={element:t,tooltip:i}},_find:function(n){var t=n.data("ui-tooltip-id");return t?this.tooltips[t]:null},_removeTooltip:function(n){n.remove();delete this.tooltips[n.attr("id")]},_appendTo:function(n){var t=n.closest(".ui-front, dialog");return t.length||(t=this.document[0].body),t},_destroy:function(){var t=this;n.each(this.tooltips,function(i,r){var f=n.Event("blur"),u=r.element;f.target=f.currentTarget=u[0];t.close(f,!0);n("#"+i).remove();u.data("ui-tooltip-title")&&(u.attr("title")||u.attr("title",u.data("ui-tooltip-title")),u.removeData("ui-tooltip-title"))});this.liveRegion.remove()}});n.uiBackCompat!==!1&&n.widget("ui.tooltip",n.ui.tooltip,{options:{tooltipClass:null},_tooltip:function(){var n=this._superApply(arguments);return this.options.tooltipClass&&n.tooltip.addClass(this.options.tooltipClass),n}});fr=n.ui.tooltip});$(function(){window.console=window.console||function(){var n={};return n.log=n.warn=n.debug=n.info=n.error=n.time=n.dir=n.profile=n.clear=n.exception=n.trace=n.assert=function(){},n}()});var g_AutoSaveTimeoutID=-1,g_AutoSaveDelay=3e4,g_LastSaveStamp,g_Saving=!1;$(document).ready(function(){function n(){if(g_LastSaveStamp){var n=Math.floor((new Date-g_LastSaveStamp)/6e4);$(".opslaanLaatste").toggle(n>0);$(".opslaan.minutengeleden").text(n);$(".opslaan.minuut").toggle(n==1);$(".opslaan.minuten").toggle(n>1)}}$(this).on("timeUpdate",n)});jQuery.fn.saveForm=function(n){var t,i;return g_Saving?this:(ClearSaveTimer(),fixFormData(),t={beforeSend:function(){g_Saving=!0;$().startNonClickableOverlay();SetNavigatieEnabled(!1)},success:function(n){g_LastSaveStamp=new Date;var t=$(n).find("secondsremaining").text()||0;return StartTimerDisplay(t),!0},complete:function(){g_Saving=!1;$("body").data("connectionError")==="true"&&ShowConnectionWarning||SetNavigatieEnabled(!0);$().endNonClickableOverlay()}},$.extend(t,n),i=$("#SubmitForm").serialize(),AsyncSubmit({url:"autosave.ctrl",data:i,handler:t,desc:"Autosave"}),this)};$(document).ready(function(){var n=$("#btnSave");if(n.length>0){n.click(function(){$().saveForm()});$(document).keydown(function(n){n.which==83&&n.ctrlKey&&$().saveForm()});$("input:text, input:password, textarea").on("keyup paste cut",StartAutoSaveCountdown);$("input:checkbox, input:radio,select").change(StartAutoSaveCountdown);$(".Puntenbalk input[type=button]").click(StartAutoSaveCountdown)}});$(document).ready(function(){$(this).bind("Error",function(){if($("body").data("connectionError","true"),ShowConnectionWarning==="undefined"||ShowConnectionWarning){$("div.Navigatie.ConnectionProblem").is(":visible")||($(".Warning.ConnectionProblem").warn(null,"ModalBlock",1e3),$("div.Navigatie.ConnectionProblem").show(),$("#divHead").hide(),SetNavigatieEnabled(!1));var n=(new Date).valueOf()+12e3;(g_retryTimestamp==undefined||g_retryTimestamp<(new Date).valueOf())&&(g_retryTimestamp=n,$(document).bind("timeUpdate",function(t){var i=Math.ceil((n-t.currentTime)/1e3);$(".RetryConnectionSeconds").text(i);i>1?($(".RetrySeconden").show(),$(".RetrySeconde").hide()):($(".RetrySeconden").hide(),$(".RetrySeconde").show());i<=0?($(".PendingRetry").hide(),$(".Retrying").show(),$(this).unbind("timeUpdate"),$(document).saveForm()):($(".PendingRetry").show(),$(".Retrying").hide())}))}});$(this).bind("ConnectionSucces",function(){$("body").data("connectionError","false");g_resubmit&&clearTimeout(g_resubmit);SetNavigatieEnabled(!0);$(".Warning.ConnectionProblem").cloak();$("div.Navigatie.ConnectionProblem").hide();$("#divHead").show()});$("body").data("connectionError","false")});SubmitBlocker.instance=null;SubmitBlocker.get=function(){return SubmitBlocker.instance||(SubmitBlocker.instance=new SubmitBlocker),SubmitBlocker.instance};SubmitBlocker.prototype={add:function(n){return this.id+=1,this.blockers.push({resolve:n,id:this.id}),this.id},remove:function(n){for(var r,i=this.blockers,t=0;t<this.blockers.length;t++)if(i[t].id===n){i.splice(t,1);break}this.submitBlocked&&this.blockers.length===0&&(r=this.submitBlocked,this.submitBlocked=null,r())},removeAll:function(){if(this.blockers=[],this.submitBlocked){var n=this.submitBlocked;this.submitBlocked=null;n()}},blockSubmit:function(n){var i=this.blockers,t;if(i.length){for(this.submitBlocked=n,t=0;t<i.length;t++)i[t].resolve();return!0}return!1}},function(n){var i=/*@cc_on!@*/!1||!!document.documentMode,t;i||(t=n.fn.html,n.fn.formhtml=function(){return arguments.length?t.apply(this,arguments):(n("input,button",this).each(function(){this.setAttribute("value",this.value)}),n("textarea",this).each(function(){this.setAttribute("value",this.value);n(this).text(this.value)}),n(":radio,:checkbox",this).each(function(){this.checked?this.setAttribute("checked","checked"):this.removeAttribute("checked")}),n("option",this).each(function(){this.selected?this.setAttribute("selected","selected"):this.removeAttribute("selected")}),t.apply(this))},n.fn.html=n.fn.formhtml)}(jQuery);var g_ReadyForRealSubmit=!1,g_RealSubmitOnly=!1,g_AjaxSubmitting=!1,g_ErrorCount=0,g_doSubmit=!1,g_SkipValidation=!1;$(document).ready(function(){$("#SubmitForm").submit(function(){return g_ReadyForRealSubmit||g_RealSubmitOnly?(g_RealSubmitOnly&&SetNavigatieEnabled(!1),CheckForSubmitBlock()):QuickSaveBeforeSubmit()})});!function(n,t){"object"==typeof exports?module.exports=t():"function"==typeof define&&define.amd?define(t):n.Spinner=t()}(this,function(){"use strict";function i(n,t){var i,r=document.createElement(n||"div");for(i in t)r[i]=t[i];return r}function t(n){for(var t=1,i=arguments.length;i>t;t++)n.appendChild(arguments[t]);return n}function a(n,t,i,r){var f=["opacity",t,~~(100*n),i,r].join("-"),e=.01+i/r*100,s=Math.max(1-(1-n)/t*(100-e),n),h=u.substring(0,u.indexOf("Animation")).toLowerCase(),c=h&&"-"+h+"-"||"";return l[f]||(o.insertRule("@"+c+"keyframes "+f+"{0%{opacity:"+s+"}"+e+"%{opacity:"+n+"}"+(e+.01)+"%{opacity:1}"+(e+t)%100+"%{opacity:"+n+"}100%{opacity:"+s+"}}",o.cssRules.length),l[f]=1),f}function e(n,t){var r,i,u=n.style;for(t=t.charAt(0).toUpperCase()+t.slice(1),i=0;i<c.length;i++)if(r=c[i]+t,void 0!==u[r])return r;if(void 0!==u[t])return t}function n(n,t){for(var i in t)n.style[e(n,i)||i]=t[i];return n}function s(n){for(var r,i,t=1;t<arguments.length;t++){r=arguments[t];for(i in r)void 0===n[i]&&(n[i]=r[i])}return n}function h(n,t){return"string"==typeof n?n:n[t%n.length]}function r(n){this.opts=s(n||{},r.defaults,y)}function v(){function u(n,t){return i("<"+n+' xmlns="urn:schemas-microsoft.com:vml" class="spin-vml">',t)}o.addRule(".spin-vml","behavior:url(#default#VML)");r.prototype.lines=function(i,r){function s(){return n(u("group",{coordsize:o+" "+o,coordorigin:-e+" "+-e}),{width:o,height:o})}function c(i,f,o){t(a,t(n(s(),{rotation:360/r.lines*i+"deg",left:~~f}),t(n(u("roundrect",{arcsize:r.corners}),{width:e,height:r.width,left:r.radius,top:-r.width>>1,filter:o}),u("fill",{color:h(r.color,i),opacity:r.opacity}),u("stroke",{opacity:0}))))}var f,e=r.length+r.width,o=2*e,l=2*-(r.width+r.length)+"px",a=n(s(),{position:"absolute",top:l,left:l});if(r.shadow)for(f=1;f<=r.lines;f++)c(f,-2,"progid:DXImageTransform.Microsoft.Blur(pixelradius=2,makeshadow=1,shadowopacity=.3)");for(f=1;f<=r.lines;f++)c(f);return t(i,a)};r.prototype.opacity=function(n,t,i,r){var u=n.firstChild;r=r.shadow&&r.lines||0;u&&t+r<u.childNodes.length&&(u=u.childNodes[t+r],u=u&&u.firstChild,u=u&&u.firstChild,u&&(u.opacity=i))}}var u,c=["webkit","Moz","ms","O"],l={},o=function(){var n=i("style",{type:"text/css"});return t(document.getElementsByTagName("head")[0],n),n.sheet||n.styleSheet}(),y={lines:12,length:7,width:5,radius:10,rotate:0,corners:1,color:"#000",direction:1,speed:1,trail:100,opacity:.25,fps:20,zIndex:2e9,className:"spinner",top:"50%",left:"50%",position:"absolute"},f;return r.defaults={},s(r.prototype,{spin:function(t){this.stop();var f=this,r=f.opts,e=f.el=n(i(0,{className:r.className}),{position:r.position,width:0,zIndex:r.zIndex});if(r.radius+r.length+r.width,n(e,{left:r.left,top:r.top}),t&&t.insertBefore(e,t.firstChild||null),e.setAttribute("role","progressbar"),f.lines(e,f.opts),!u){var s,h=0,l=(r.lines-1)*(1-r.direction)/2,c=r.fps,o=c/r.speed,a=(1-r.opacity)/(o*r.trail/100),v=o/r.lines;!function y(){h++;for(var n=0;n<r.lines;n++)s=Math.max(1-(h+(r.lines-n)*v)%o*a,r.opacity),f.opacity(e,n*r.direction+l,s,r);f.timeout=f.el&&setTimeout(y,~~(1e3/c))}()}return f},stop:function(){var n=this.el;return n&&(clearTimeout(this.timeout),n.parentNode&&n.parentNode.removeChild(n),this.el=void 0),this},lines:function(r,f){function s(t,r){return n(i(),{position:"absolute",width:f.length+f.width+"px",height:f.width+"px",background:t,boxShadow:r,transformOrigin:"left",transform:"rotate("+~~(360/f.lines*e+f.rotate)+"deg) translate("+f.radius+"px,0)",borderRadius:(f.corners*f.width>>1)+"px"})}for(var o,e=0,c=(f.lines-1)*(1-f.direction)/2;e<f.lines;e++)o=n(i(),{position:"absolute",top:1+~(f.width/2)+"px",transform:f.hwaccel?"translate3d(0,0,0)":"",opacity:f.opacity,animation:u&&a(f.opacity,f.trail,c+e*f.direction,f.lines)+" "+1/f.speed+"s linear infinite"}),f.shadow&&t(o,n(s("#000","0 0 4px #000"),{top:"2px"})),t(r,t(o,s(h(f.color,e),"0 0 1px rgba(0,0,0,.1)")));return r},opacity:function(n,t,i){t<n.childNodes.length&&(n.childNodes[t].style.opacity=i)}}),f=n(i("group"),{behavior:"url(#default#VML)"}),!e(f,"transform")&&f.adj?v():u=e(f,"animation"),r}),function(n){n.fn.startNonClickableOverlay=function(){n(".nonClickableOverlay").length==0&&(n("body").prepend("<div class='nonClickableOverlay'><\/div>"),n(".nonClickableOverlay").click(function(n){n.stopPropagation()}))};n.fn.endNonClickableOverlay=function(){n(".nonClickableOverlay").remove()};n.fn.startLoadingOverlay=function(t){this.startNonClickableOverlay();n("body").addClass("progressBody");this.showLoading(t)};n.fn.showLoading=function(t){setTimeout(function(){n(".nonClickableOverlay").length&&(n("body").append("<div class='loadingModal'><\/div>"),n("body").removeClass("progressBody"),n("body").addClass("loadingBody"))},t)};n.fn.endLoadingOverlay=function(){this.endNonClickableOverlay();n("body").removeClass("progressBody");n("body").removeClass("loadingBody");n(".loadingModal").remove()}}(jQuery);
